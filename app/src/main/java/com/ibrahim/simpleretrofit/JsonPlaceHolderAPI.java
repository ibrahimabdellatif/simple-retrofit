...
public interface JsonPlaceHolderAPI {
     ...
     * @HEADERS() contain http meta data "but you should specify content type like (application/json;)"
     * headers end point must be write without no space before colon
     * ,like this "Static-Header1: 123" but not like this "Static-Header1 : 123"*/
